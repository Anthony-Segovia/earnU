...
async function decryptECIES(privateKey, cipherObject) {
    ...
    const plainText = await aes256CbcDecrypt(common_1.Buffer.from(ivBuffer), sharedKeys.encryptionKey, cipherTextBuffer);
